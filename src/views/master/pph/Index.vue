 <template>
  <div>
    <base-title title="PPH" subtitle="List Data PPH" />
          ...
          <v-dialog v-model="dialogForm" max-width="400px" persistent>
            ...
            <v-form ref="form_data" v-model="form_valid" lazy-validation>
              <v-card class="rounded-lg">
                ...
                <v-card-text>
                  <v-text-field
                    v-model="form_data.percentage"
                    label="Percentage"
                    outlined
                    dense
                    :rules="rule_percentage"
                  >
                  </v-text-field>
...
export default {
  ...
  data: () => ({
    ...
    rule_percentage: [
      (v) => !!v || "PPH percentage please fill in !!!",
      (v) => v >= 0 || "PPH cannot be below 0",
      (v) => v <= 100 || "PPH must not be above 100",
      (v) => /^[0-9]+$/.test(v) || "PPH can only be numbers",
    ],
    rule_description: [(value) => !!value || "PPH description please fill in"],
  }),
      ...
      if (this.$refs.form_data.validate()) {
        ...
        if (this.editedIndex > -1) {
          await this.$axios
            ...
            .then(({ data }) => {
              Object.assign(this.datatable[this.editedIndex], data.pph);
