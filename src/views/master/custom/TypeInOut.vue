 <template>
  <div>
    <base-title title="Type In / Out" subtitle="List Data Type In / Out" />
    <v-data-table
      :headers="headers"
      :items="datatable"
      :search="search"
  ...
  methods: {
    initialize: async function () {
      ...
      await this.$axios
        ...
        .then(({ data }) => {
          this.datatable = data.type_in_out;
      ...
      if (this.$refs.form_data.validate()) {
        ...
        if (this.editedIndex > -1) {
          await this.$axios
            ...
            .then(({ data }) => {
              Object.assign(this.datatable[this.editedIndex], data.type_in_out);
          ...
          await this.$axios
            ...
            .then(({ data }) => {
              this.datatable.push(data.type_in_out);
              this.closedialogForm();
              this.btnLoading = false;
            })
            .catch(() => {
