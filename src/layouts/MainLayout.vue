  ...
  <div>
    ...
    <v-navigation-drawer width="240" dark color="darkblue" app v-model="drawer">
      <v-list-item>
        <v-list-item-content>
          <v-list-item-title class="title">
            <img src="@/assets/gmk_logo_white.svg" class="mx-5" />
          </v-list-item-title>
        </v-list-item-content>
      </v-list-item>
      ...
      <v-list-item-group color="#898F99" v-model="group">
        <v-list-item-title class="ml-4 mb-2" style="font-size: 14px"
          v-if="CAN('Manage-Master')">Master</v-list-item-title>
        ...
        <v-list-group :value="false" prepend-icon="mdi-dolly">
          ...
          <v-list-item class="ml-3" to="/purchase-shipping">
            ...
            <v-list-item-content>
              <v-list-item-title style="font-size: 14px">Shipping Intruction</v-list-item-title>
            </v-list-item-content>
          </v-list-item>
        </v-list-group>
